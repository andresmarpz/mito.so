...
This is a Next.js 15 chat application frontend that communicates with a Python backend via server-sent events (SSE). The application is part of a larger mito monorepo structure.
